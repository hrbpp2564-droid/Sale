    ...
    return (
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          {!(window.BWP_USER && window.BWP_USER.readOnly) && <Button variant="secondary" size="md" iconLeft={<Icon name="edit" size={15} />} onClick={() => window.location.href = '/bwp-data-editor/'}>แก้ไขข้อมูล</Button>}
